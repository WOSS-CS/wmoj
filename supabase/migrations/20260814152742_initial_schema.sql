-- ============================================================================
-- 20260814152742_initial_schema — WMOJ baseline migration
-- ============================================================================
-- This is the FIRST migration in supabase/migrations/. It captures the
-- complete WMOJ database schema as it existed in production on 2026-08-14,
-- and serves as the baseline every later migration builds on. It was
-- previously the repo-root `schema.sql` dump.
--
-- Do NOT edit this file to change the schema. Every subsequent change —
-- however small — belongs in a NEW timestamped migration alongside it, so
-- the history stays traceable and reversible. See AGENTS.md.
--
-- Paste this into the SQL editor of a fresh Supabase project and run it once.
-- The script is idempotent: every CREATE statement is guarded by IF NOT
-- EXISTS, OR REPLACE, or DROP IF EXISTS, so it can be safely re-run.
--
...
-- ============================================================================
-- End of 20260814152742_initial_schema
-- ============================================================================
