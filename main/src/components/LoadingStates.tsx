...
export function PageLoading({
  ...
  return (
    <div
      className={`min-h-screen bg-gradient-to-br from-black via-gray-900 to-black flex items-center justify-center ${className}`}
    >
      <div className="text-center space-y-6">
        <div className="relative w-24 h-24 mx-auto">
          ...
          <div className="flex items-end justify-center gap-1 h-full">
            <div
              className="w-3 bg-gradient-to-t from-gray-600 to-gray-500 rounded-t animate-pulse"
        ...
        <div className="w-48 h-1 bg-gray-800 rounded-full mx-auto overflow-hidden">
          <div className="h-full bg-gradient-to-r from-gray-600 to-gray-500 rounded-full animate-shimmer"></div>
        </div>
      </div>
    </div>
  );
...
export function CardLoading({ className = "", count = 3 }: CardLoadingProps) {
  return (
    <div
...
export function ListLoading({ className = "", items = 5 }: ListLoadingProps) {
