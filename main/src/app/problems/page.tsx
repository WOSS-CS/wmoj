...
export default function ProblemsPage() {
  ...
  const [statusByProblem, setStatusByProblem] = useState<
    Record<string, "solved" | "attempted" | "not_attempted">
  >({});
            ...
            <aside className="w-64 bg-white/5 backdrop-blur-lg border-r border-white/10 min-h-screen">
              <div className="p-6 space-y-6">
                ...
                <nav className="space-y-2">
                  ...
                  <Link
                    href="/problems"
                    className="flex items-center gap-3 px-4 py-3 text-green-400 bg-green-400/10 rounded-lg border border-green-400/20"
                  >
                    <svg
                      className="w-5 h-5"
                      fill="none"
              ...
              >
                ...
                >
                  ...
                  <p className="text-gray-300 text-lg">
                    Solve standalone problems to improve your competitive
                    programming skills
                  </p>
                </div>
              </LoadingState>
                ...
                <div className="space-y-4">
                  {problems.length === 0 ? (
                    <div className="text-center py-12">
                      <svg
                        className="w-16 h-16 mx-auto mb-4 text-gray-500 animate-bounce"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
                      ...
                      <p className="text-gray-300">
                        There are no standalone problems available at the
                        moment.
                      </p>
                    </div>
                  ) : (
                    <>
                      ...
                      {filteredProblems.length === 0 ? (
                        <div className="text-center py-12">
                          ...
                          <p className="text-gray-300">
                            No problems match your search criteria. Try a
                          ...
                          {(() => {
                            ...
                            const columns: Array<DataTableColumn<Row>> = [
                              ...
                              },
                              {
                                ...
                                render: (r) => {
                                  const st =
                                    statusByProblem[r.id] || "not_attempted";
                                  if (st === "solved") {
                                    return (
                                      <span className="px-3 py-1 bg-green-400/20 text-green-400 rounded-full text-xs">
                                        Solved
                                  ...
                                  if (st === "attempted") {
                                    return (
                                      <span className="px-3 py-1 bg-yellow-400/20 text-yellow-400 rounded-full text-xs">
                                        Attempted
                                      </span>
                                    );
                                  }
                                  return (
                                    <span className="px-3 py-1 bg-gray-400/20 text-gray-400 rounded-full text-xs">
                                      Not Attempted
                                    </span>
                                  );
                                },
