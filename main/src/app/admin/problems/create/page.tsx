        ...
        <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black relative overflow-hidden">
          ...
          <div className="absolute inset-0 pointer-events-none">
            ...
            <div className="absolute inset-0 opacity-10">
              ...
              <div className="absolute top-20 left-20 w-32 h-0.5 bg-gradient-to-r from-blue-400 to-transparent animate-pulse"></div>
              <div className="absolute top-20 left-52 w-2 h-2 bg-blue-400 rounded-full animate-pulse" style={{ animationDelay: '0.5s' }}></div>
              ...
              <div className="absolute bottom-8 left-60 w-2 h-2 bg-blue-400 rounded-full animate-pulse" style={{ animationDelay: '3s' }}></div>
            </div>
          </div>
