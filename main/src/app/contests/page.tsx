                      ...
                      {filteredContests.length === 0 ? (
                        <div className="text-center py-12">
                          ...
                          <p className="text-gray-300">
                            No contests match your search criteria. Try a
                                ...
                                render: (r) => (
                                  <div className="flex items-center gap-3 flex-wrap">
                                    ...
                                    <span className="px-2 py-0.5 text-xs rounded-full bg-green-400/15 text-green-300 border border-green-400/30">
                                      {r.problems_count ?? 0} problem
                                      {(r.problems_count ?? 0) === 1 ? "" : "s"}
                                    </span>
                                  </div>
                                ),
                              },
                              ...
                              },
                              {
                                ...
                                render: (r) => (
                                  <span className="text-gray-300 text-sm">
                                    {r.participants_count ?? 0} participant
                                    {(r.participants_count ?? 0) === 1
                                      ? ""
                                      : "s"}
                                  </span>
                                ),
