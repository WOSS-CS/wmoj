  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        ...
        if (contestRes.ok && contestJson.contest?.name)
          setContestName(contestJson.contest.name);
                ...
                <div>
                  <div className="mb-6">
                    ...
                    <p className="text-gray-400 text-sm mt-1">
                      View-only leaderboard. Problems are not visible after your
                      time is up.
                    </p>
                  </div>
                    ...
                    {leaderboard.length === 0 ? (
                      ...
                      <div className="space-y-3">
                        {leaderboard.map((entry, index) => (
                          <div
                            key={entry.user_id}
                            className="flex items-center justify-between bg-white/5 rounded-xl p-5 border border-white/10"
                          >
