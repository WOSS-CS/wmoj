      ...
      <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black flex items-center justify-center p-6 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md w-full">
          ...
          <div className={`text-center mb-8 transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ transitionDelay: '0.2s' }}>
            <div className="text-4xl font-bold text-white mb-2 group cursor-pointer">
            ...
            <p className="text-gray-400 text-lg">Join the competitive programming community</p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center">
                <input 
                  ...
                  id="terms" 
                  required
                  className="mr-3 rounded border-white/20 bg-white/10 text-green-600 focus:ring-green-500 focus:ring-2 transition-all duration-300 hover:scale-110"
                />
